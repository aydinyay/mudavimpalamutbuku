    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            ['category' => $raki, 'data' => ['price' => 500, 'sort_order' => 1],
             'tr' => ['name' => 'Yeni Rakı Tek', 'description' => ''], 'en' => ['name' => 'Yeni Raki Single', 'description' => ''], 'de' => ['name' => 'Yeni Raki Einfach', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 600, 'sort_order' => 2],
             'tr' => ['name' => 'Yeni Rakı Double', 'description' => ''], 'en' => ['name' => 'Yeni Raki Double', 'description' => ''], 'de' => ['name' => 'Yeni Raki Doppelt', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 1500, 'sort_order' => 3],
             'tr' => ['name' => 'Yeni Rakı 20cl', 'description' => ''], 'en' => ['name' => 'Yeni Raki 20cl', 'description' => ''], 'de' => ['name' => 'Yeni Raki 20cl', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 2000, 'sort_order' => 4],
             'tr' => ['name' => 'Yeni Rakı 35cl', 'description' => ''], 'en' => ['name' => 'Yeni Raki 35cl', 'description' => ''], 'de' => ['name' => 'Yeni Raki 35cl', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 3000, 'sort_order' => 5],
             'tr' => ['name' => 'Yeni Rakı 70cl', 'description' => ''], 'en' => ['name' => 'Yeni Raki 70cl', 'description' => ''], 'de' => ['name' => 'Yeni Raki 70cl', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 1700, 'sort_order' => 6],
             'tr' => ['name' => 'Efe Gold 20cl', 'description' => ''], 'en' => ['name' => 'Efe Gold 20cl', 'description' => ''], 'de' => ['name' => 'Efe Gold 20cl', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 2250, 'sort_order' => 7],
             'tr' => ['name' => 'Efe Gold 35cl', 'description' => ''], 'en' => ['name' => 'Efe Gold 35cl', 'description' => ''], 'de' => ['name' => 'Efe Gold 35cl', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 3400, 'sort_order' => 8],
             'tr' => ['name' => 'Efe Gold 70cl', 'description' => ''], 'en' => ['name' => 'Efe Gold 70cl', 'description' => ''], 'de' => ['name' => 'Efe Gold 70cl', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 1900, 'sort_order' => 9],
             'tr' => ['name' => 'Beylerbeyi Göbek 20cl', 'description' => ''], 'en' => ['name' => 'Beylerbeyi Gobek 20cl', 'description' => ''], 'de' => ['name' => 'Beylerbeyi Gobek 20cl', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 2400, 'sort_order' => 10],
             'tr' => ['name' => 'Beylerbeyi Göbek 35cl', 'description' => ''], 'en' => ['name' => 'Beylerbeyi Gobek 35cl', 'description' => ''], 'de' => ['name' => 'Beylerbeyi Gobek 35cl', 'description' => ''], 'allergens' => []],
            ['category' => $raki, 'data' => ['price' => 3750, 'sort_order' => 11],
             'tr' => ['name' => 'Beylerbeyi Göbek 70cl', 'description' => ''], 'en' => ['name' => 'Beylerbeyi Gobek 70cl', 'description' => ''], 'de' => ['name' => 'Beylerbeyi Gobek 70cl', 'description' => ''], 'allergens' => []],
            ...
            ['category' => $sarap, 'data' => ['price' => 2100, 'sort_order' => 2],
             'tr' => ['name' => 'Angora Beyaz 70cl', 'description' => ''], 'en' => ['name' => 'Angora White 70cl', 'description' => ''], 'de' => ['name' => 'Angora Weiß 70cl', 'description' => ''], 'allergens' => [$molluscs]],
            ['category' => $sarap, 'data' => ['price' => 2500, 'sort_order' => 3],
             'tr' => ['name' => 'Kav Narince 70cl', 'description' => ''], 'en' => ['name' => 'Kav Narince 70cl', 'description' => ''], 'de' => ['name' => 'Kav Narince 70cl', 'description' => ''], 'allergens' => [$molluscs]],
            ['category' => $sarap, 'data' => ['price' => 3700, 'sort_order' => 4],
             'tr' => ['name' => 'Sarafin Sauvignon Blanc 70cl', 'description' => ''], 'en' => ['name' => 'Sarafin Sauvignon Blanc 70cl', 'description' => ''], 'de' => ['name' => 'Sarafin Sauvignon Blanc 70cl', 'description' => ''], 'allergens' => [$molluscs]],
            ['category' => $sarap, 'data' => ['price' => 3900, 'sort_order' => 5],
             'tr' => ['name' => 'Sarafin Chardonnay 70cl', 'description' => ''], 'en' => ['name' => 'Sarafin Chardonnay 70cl', 'description' => ''], 'de' => ['name' => 'Sarafin Chardonnay 70cl', 'description' => ''], 'allergens' => [$molluscs]],
            ['category' => $sarap, 'data' => ['price' => 650, 'sort_order' => 6],
            ...
            ['category' => $sarap, 'data' => ['price' => 2100, 'sort_order' => 7],
             'tr' => ['name' => 'Angora Kırmızı 70cl', 'description' => ''], 'en' => ['name' => 'Angora Red 70cl', 'description' => ''], 'de' => ['name' => 'Angora Rot 70cl', 'description' => ''], 'allergens' => [$molluscs]],
            ['category' => $sarap, 'data' => ['price' => 2500, 'sort_order' => 8],
             'tr' => ['name' => 'Kav Öküzgözü 70cl', 'description' => ''], 'en' => ['name' => 'Kav Okuzkoz 70cl', 'description' => ''], 'de' => ['name' => 'Kav Okuzkoz 70cl', 'description' => ''], 'allergens' => [$molluscs]],
            ['category' => $sarap, 'data' => ['price' => 3700, 'sort_order' => 9],
             'tr' => ['name' => 'Sarafin Cabernet Sauvignon 70cl', 'description' => ''], 'en' => ['name' => 'Sarafin Cabernet Sauvignon 70cl', 'description' => ''], 'de' => ['name' => 'Sarafin Cabernet Sauvignon 70cl', 'description' => ''], 'allergens' => [$molluscs]],
            ['category' => $sarap, 'data' => ['price' => 2500, 'sort_order' => 10],
             'tr' => ['name' => 'Datça Wineyard Blush', 'description' => ''], 'en' => ['name' => 'Datça Wineyard Blush', 'description' => ''], 'de' => ['name' => 'Datça Wineyard Blush', 'description' => ''], 'allergens' => [$molluscs]],
