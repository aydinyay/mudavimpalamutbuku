...
class MenuItemController extends Controller
{
    ...
    private function validateItem(Request $request, ?MenuItem $existing = null): array
    {
        $request->validate([
            ...
            'ingredients_tr' => 'nullable|string',
            'ingredients_en' => 'nullable|string',
            'ingredients_de' => 'nullable|string',
            'meat_origin'    => 'nullable|string|max:100',
            'serving_size_g' => 'nullable|integer|min:0|max:9999',
        ...
        return [
            'item' => [
                ...
                'ingredients_tr' => $request->ingredients_tr,
                'ingredients_en' => $request->ingredients_en,
                'ingredients_de' => $request->ingredients_de,
                'meat_origin'    => $request->meat_origin ?: null,
                'serving_size_g' => $request->serving_size_g ?: null,
